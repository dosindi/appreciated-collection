        ...
        try {
            FlexibleGridLayout layout = new FlexibleGridLayout()
                    ...
                    .withItems(
                            ...
                            getCard("./frontend/images/swiper/logo.png", "Swiper Addon", "A component to build horizontally and vertically scrollable containers with stops", SwiperDemo.class),
