...
public class AppLayoutDemo extends DemoHelperView {
    ...
    public AppLayoutDemo() {
        withHorizontalHeader("AppLayout", "A responsive layout that allows you to create modern Menus quickly", "./frontend/images/applayout/app-layout-logo.png")
                .withDevice(new PhoneView(new Embed(MainView.class).withFullSize()), "Optimized for small screens")
                ...
                .withStylableDevice(new Embed(MainView.class).withFullSize(), DeviceType.TABLET_LANDSCAPE)
                ...
                new CodeExample(new CodeExampleFormatter(View1.class.getName()).getCodeExample(), "java", "Java"),
